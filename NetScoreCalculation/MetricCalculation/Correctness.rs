...
pub fn calculate_percentage(open: f64, closed: f64, users: f64) -> f64{       
...
//! Best to use NetScore.rs instead. Compile NetScore.rs with the 'rustc NetScore.rs' command, and run the executable with 3 args (open issues, closed issues, users)
fn main() {
