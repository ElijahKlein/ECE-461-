...
pub fn calculate_size(repo_size: f64, num_contributors: f64) -> f64 {
    ...
    if unweighted <= 5.0 {                    //5 files per cont
        return 1.0;
    }
    else if unweighted <= 10.0 {              //10 files per cont
        return 0.9;
    }
    else if unweighted <= 20.0 {              //20 files per cont
        return 0.8;
    }
    else if unweighted <= 30.0 {              //etc...
        return 0.7;
    }
    ...
    else if unweighted <= 60.0 {
        return 0.4;
    }
    else if unweighted <= 70.0 {
        return 0.3;
    }
    else if unweighted <= 80.0 {
        return 0.2;
    }
